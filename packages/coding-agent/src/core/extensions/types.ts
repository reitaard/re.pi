...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@reitaard/repi-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@reitaard/repi-coding-agent";
	 *
...
export type InlineExtension =
	...
	| {
			...
			/** Hide built-in plumbing extensions from user-facing discovery lists. */
			hidden?: boolean;
	  };
