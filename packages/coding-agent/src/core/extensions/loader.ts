...
import * as _bundledPiAgentCore from "@reitaard/repi-agent-core";
import type { Provider } from "@reitaard/repi-ai";
import * as _bundledPiAiCompat from "@reitaard/repi-ai/compat";
import * as _bundledPiAiOauth from "@reitaard/repi-ai/oauth";
import type { KeyId } from "@reitaard/repi-tui";
import * as _bundledPiTui from "@reitaard/repi-tui";
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@reitaard/repi-agent-core": _bundledPiAgentCore,
	"@reitaard/repi-tui": _bundledPiTui,
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	"@reitaard/repi-ai": _bundledPiAiCompat,
	"@reitaard/repi-ai/compat": _bundledPiAiCompat,
	"@reitaard/repi-ai/oauth": _bundledPiAiOauth,
	"@reitaard/repi-coding-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@reitaard/repi-agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@reitaard/repi-tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@reitaard/repi-ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@reitaard/repi-ai/oauth");

	_aliases = {
		"@reitaard/repi-coding-agent": piCodingAgentEntry,
		"@reitaard/repi-agent-core": piAgentCoreEntry,
		"@reitaard/repi-tui": piTuiEntry,
		"@reitaard/repi-ai": piAiCompatEntry,
		"@reitaard/repi-ai/compat": piAiCompatEntry,
		"@reitaard/repi-ai/oauth": piAiOauthEntry,
