...
import { Agent, type AgentMessage, type ThinkingLevel } from "@reitaard/repi-agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@reitaard/repi-ai/compat";
