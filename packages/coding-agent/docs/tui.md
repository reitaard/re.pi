...
**Source:** [`@reitaard/repi-tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@reitaard/repi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@reitaard/repi-tui";
...
Import from `@reitaard/repi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@reitaard/repi-tui";
```
...
```typescript
import { matchesKey, Key } from "@reitaard/repi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@reitaard/repi-tui";
...
```typescript
import { getMarkdownTheme } from "@reitaard/repi-coding-agent";
import { Markdown } from "@reitaard/repi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@reitaard/repi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@reitaard/repi-coding-agent";
import { DynamicBorder } from "@reitaard/repi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@reitaard/repi-tui";
...
```typescript
import { BorderedLoader } from "@reitaard/repi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@reitaard/repi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@reitaard/repi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@reitaard/repi-tui";
...
import { matchesKey, truncateToWidth } from "@reitaard/repi-tui";
