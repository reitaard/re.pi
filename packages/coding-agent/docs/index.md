...
```bash
npm uninstall -g @reitaard/repi-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @reitaard/repi-coding-agent`, `yarn global remove @reitaard/repi-coding-agent`, or `bun uninstall -g @reitaard/repi-coding-agent`.
