...
```typescript
import type { ExtensionAPI } from "@reitaard/repi-coding-agent";
...
| Package | Purpose |
|---------|---------|
| `@reitaard/repi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@reitaard/repi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@reitaard/repi-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@reitaard/repi-coding-agent";
...
```typescript
import { isBashToolResult } from "@reitaard/repi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@reitaard/repi-coding-agent";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@reitaard/repi-coding-agent";
...
```typescript
import { SessionManager } from "@reitaard/repi-coding-agent";
...
```typescript
import { Type } from "typebox";
import { StringEnum } from "@reitaard/repi-ai";
...
```typescript
import type { AutocompleteItem } from "@reitaard/repi-tui";
...
```typescript
import { Box, Text } from "@reitaard/repi-tui";
...
```typescript
import { withFileMutationQueue } from "@reitaard/repi-coding-agent";
...
**Important:** Use `StringEnum` from `@reitaard/repi-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@reitaard/repi-coding-agent";
...
```typescript
import { createBashTool } from "@reitaard/repi-coding-agent";
...
```typescript
import { keyHint } from "@reitaard/repi-coding-agent";
...
```typescript
import { Text, Component } from "@reitaard/repi-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@reitaard/repi-coding-agent";
import { matchesKey } from "@reitaard/repi-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@reitaard/repi-coding-agent";
