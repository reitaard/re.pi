...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@reitaard/repi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@reitaard/repi-tui";
