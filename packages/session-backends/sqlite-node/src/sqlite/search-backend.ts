import type { SessionSearch, SessionSearchHit, SessionSearchOptions } from "@reitaard/repi-agent-core";
import { getFileSystemResultOrThrow } from "@reitaard/repi-agent-core";
