...
Read [`docs/RECODE_BUILD_RELEASE.md`](../../../docs/RECODE_BUILD_RELEASE.md) completely before acting. It is the detailed runbook; this skill is the small-model execution guardrail.
