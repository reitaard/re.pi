...
const internalPackagePrefix = "@reitaard/repi-";
const installPackageName = "@reitaard/repi-coding-agent-install";
...
function createInstallerPackageJson(codingAgentPackage) {
	const packageJson = {
		...
		private: true,
		description: "Lockfile root used by the Recode installer and updater.",
		dependencies: {
